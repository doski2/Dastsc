...
→ **[brake-module.md](./brake-module.md)** — mapa de archivos, flujo, escenarios TSC, árbol de
decisión.
...
| Archivo                                  | Rol                                                           |
| ---------------------------------------- | ------------------------------------------------------------- |
| `nexus-agent/src/brake/planBrake.ts`     | Plan cinemático; prioridad señal → límite → estación; cluster |
