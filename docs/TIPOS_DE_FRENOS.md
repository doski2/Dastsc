...
Para la Fase 4 (Automatización), el sistema distingue entre varios tipos de frenado para aplicar la
fuerza de forma realista.

## 1. COMBINED_BLENDED (Mando Único Inteligente)

* **Trenes típicos:** Class 323, Class 375, Class 450.
* **Funcionamiento:** Una sola palanca controla tracción y freno. El tren decide automáticamente

  cuánta fuerza eléctrica (dinámica) y cuánta de aire (neumática) usar.
...
* **Funcionamiento:** Palancas separadas para el regulador y el freno de tren. El freno de aire

  tiene un retardo natural (llenado de tubería).
...
* **Funcionamiento:** Similar al blended pero con integración en los sistemas de seguridad PZB/LZB
